...
const HalamanUtama = () => {
    return (
       <>
            <section>
                <header>
                    <div className="container-sm container-md container-lg container-xl container-2xl bg-no-repeat bg-cover bg-center" style={{backgroundImage: "url('src/assets/muktasim-azlan-rjWfNR_AC5g-unsplash (1).jpg')"}}>
                        <div>
                            <NavbarHL />
                        </div>
                        <div className="container-sm container-md container-lg container-xl container-2xl flex justify-center">
                            <div className="box-border w-2/3 my-20" >
                                <div className="columns mx-auto py-40 flex flex-col">
                                    ...
                                    <p className='text-white font-montserrat text-xl mt-10'>Immediately Order Your Court and<br />Start Competing!</p>
                                    <div className="w-32 mt-10 ms-32">
                                        <button 
                ...
                <div className="container-sm container-md container-lg container-xl container-2xl bg-white flex justify-center" id="About">
                    <div className="box-content my-20">
                        <div className="columns flex items-center gap-44 w-full">
                            ...
                            <div className="w-96 font-montserrat flex flex-col gap-4">
                                <p className="font-bold text-black text-3xl">About Us</p>
                                <p className="">ShuttleSpot is an online badminton court booking platform that makes it easy for you to book courts quickly.<br /> We offer access to a variety of high-quality court locations, badminton training and the best customer support.<br /> Join ShuttleSpot and enjoy a comfortable and affordable badminton experience.</p>
                            </div>
                        </div>
                    </div>
                </div>

                <div className="container-sm container-md container-lg container-xl container-2xl bg-white my-20 flex justify-center" id="TopCourt">
                    <div className="box-content">
                        <div className="columns flex flex-col gap-8 w-full">
                          <div>
                            <p  className="font-bold text-black text-3xl">Top Court in ShuttleSpot</p>
                          </div>
